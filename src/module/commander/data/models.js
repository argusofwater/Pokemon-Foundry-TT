...
export class CommanderPokemonData extends foundry.abstract.TypeDataModel {
  ...
  static defineSchema() {
    return {
      ...
      progression: new fields.SchemaField({ mode: new fields.StringField({ required: true, nullable: false, choices: ["xp", "milestone"], initial: "xp" }), experience: new fields.NumberField({ required: true, nullable: false, integer: true, min: 0, initial: 0 }), milestone: new fields.NumberField({ required: true, nullable: false, integer: true, min: 0, initial: 0 }), evolutionEligible: new fields.BooleanField({ required: true, nullable: false, initial: false }), pendingAdvancements: new fields.NumberField({ required: true, nullable: false, integer: true, min: 0, initial: 0 }) }),
