...
export class CommanderRollService {
  static async rollCheck({ actor, label, modifier = 0, target = null, favored = false, hindered = false, notes = "", defense = "" } = {}) {
    ...
    const dice = favored === finalHindered ? "1d20" : favored ? "2d20kh" : "2d20kl";
    ...
    const content = await renderTemplate("systems/ptu/src/module/commander/templates/chat/check-card.hbs", { actor, label, modifier: Number(modifier) || 0, target, total, success, favored, hindered: finalHindered, notes });
